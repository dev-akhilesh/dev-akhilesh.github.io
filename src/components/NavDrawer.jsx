...
const Navbar_options = [{ text: 'Home', id: 'home' }, { text: 'About', id: 'about' }, { text: 'Skills', id: 'skills' }, { text: 'Projects', id: 'projects' }, { text: 'Github', id: 'github' }, { text: 'Contact', id: 'contact' }];
        ...
        <>
            ...
            >
                ...
                <DrawerContent display={{ base: 'block', '836px': 'none' }} bg='rgb(1, 16, 27)' color='white'>
                    ...
                    <DrawerHeader><Heading>𝘼𝙆</Heading></DrawerHeader>
